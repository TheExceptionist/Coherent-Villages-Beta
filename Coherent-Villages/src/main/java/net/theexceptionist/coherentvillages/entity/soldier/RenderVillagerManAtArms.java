...
public class RenderVillagerManAtArms extends RenderVillagerSoldier{
	private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/soldier_d.png");
	/*
	...
	*/
    ...
    public RenderVillagerManAtArms(RenderManager renderManagerIn)
    {
