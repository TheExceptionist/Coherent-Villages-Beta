...
public class ModelVillagerSoldier extends ModelBiped {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        AbstractVillagerSoldier soldier = (AbstractVillagerSoldier) entityIn;
     ...
     //   this.leg0.rotateAngleY = 0.0F;
       ...
       if (this.isRiding)
        ...
        if(soldier.attacking)
        {
             ...
             float f11 = MathHelper.sin((1.0F - (1.0F - this.swingProgress) * (1.0F - this.swingProgress)) * (float)Math.PI);
             this.bipedRightArm.rotateAngleZ = 0.0F;
             this.bipedLeftArm.rotateAngleZ = 0.0F;
             this.bipedRightArm.rotateAngleY = 0.15707964F;
             this.bipedLeftArm.rotateAngleY = -0.15707964F;
             ...
             this.bipedLeftArm.rotateAngleX = -0.0F + MathHelper.cos(ageInTicks * 0.19F) * 0.5F;
             this.bipedRightArm.rotateAngleX += f1 * 2.2F - f11 * 0.4F;
             this.bipedLeftArm.rotateAngleX += f1 * 1.2F - f11 * 0.4F;
