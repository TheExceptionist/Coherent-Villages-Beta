...
*/
	private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/merchant.png");
	
    public RenderVillagerMerchant(RenderManager renderManagerIn)
    {
    ...
    protected ResourceLocation getEntityTexture(EntityVillager entity)
    {
    	...
    	if(entity instanceof AbstractVillagerSoldier){
    		soldier = ((AbstractVillagerSoldier)entity);
