...
import net.theexceptionist.coherentvillages.main.Resources;
	...
	public class RenderVillagerHunter  extends  RenderLiving<EntityVillager>
	{
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/hunter.png");
		...
		public RenderVillagerHunter(RenderManager renderManagerIn)
	    {
