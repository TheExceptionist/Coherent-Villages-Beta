...
import net.theexceptionist.coherentvillages.entity.EntityVillagerEvilMage;
...
public class Main
{
	...
	public void init(FMLInitializationEvent event) {
    	...
    	createEntity(EntityVillagerManAtArms.class, 1514, "villager_man_at_arms", 161425, 1582224);
    	createEntity(EntityVillagerSergeant.class, 1515, "villager_sergeant", 161425, 1582224);
    	createEntity(EntityVillagerWarrior.class, 1516, "villager_warrior", 161425, 1582224);
    	createEntity(EntityVillagerPeasant.class, 1517, "villager_peasant", 161425, 1582224);
    	createEntity(EntityVillagerMilitia.class, 1518, "villager_militia", 161425, 1582224);
    	
    	
    	createEntity(EntityVillagerArcher.class, 1519, "villager_archer", 345895, 1985323);
    	...
    	createEntity(EntityMerchantGuard.class, 1524, "villager_merchant_guard", 545895, 4985000);
    	...
    	createEntity(EntityVillagerEvilMage.class, 1529, "villager_evil", 486395, 8015567);
    	//if(biomes != null)
    	//{
