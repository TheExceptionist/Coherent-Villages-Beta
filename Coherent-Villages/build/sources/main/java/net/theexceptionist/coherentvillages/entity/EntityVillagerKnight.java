...
public class EntityVillagerKnight extends AbstractVillagerSoldier{
	...
	protected void initEntityAI()
    {
       ...
       // this.tasks.addTask(6, new EntityAIHarvestFarmland(this, 0.6D));
        ...
        this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityLiving.class, 3, false, true, new Predicate<EntityLiving>()
        {
