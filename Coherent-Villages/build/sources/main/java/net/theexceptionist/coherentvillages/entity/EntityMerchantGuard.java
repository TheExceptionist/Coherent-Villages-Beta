...
import net.theexceptionist.coherentvillages.entity.ai.EntityAIFollowMerchant;
import net.theexceptionist.coherentvillages.entity.ai.EntityAIShareTarget;
import net.theexceptionist.coherentvillages.entity.soldier.AbstractVillagerSoldier;

public class EntityMerchantGuard extends AbstractVillagerSoldier{
	...
	protected void initEntityAI()
    {
       ...
       // this.tasks.addTask(6, new EntityAIHarvestFarmland(this, 0.6D));
        ...
        this.targetTasks.addTask(0, new EntityAIAttackBackExclude(this, true, new Class[0]));
