...
public class EntityVillagerHunter extends EntityVillager implements IRangedAttackMob{
	private int armour = 2, attack = 8;
	protected int arrowType = 0;
	
	public EntityVillagerHunter(World worldIn) {
		super(worldIn);
		this.arrowType = 0;//this.rand.nextInt(2);
	}
         ...
         this.targetTasks.addTask(0, new EntityAINearestAttackableTarget(this, EntityLiving.class, 4, false, true, new Predicate<EntityLiving>()
                {
                    ...
                    {
                        return (p_apply_1_ instanceof EntityAnimal) && !(p_apply_1_ instanceof EntityHorse);//p_apply_1_ != null && IMob.MOB_SELECTOR.apply(p_apply_1_) && !(p_apply_1_ instanceof EntityCreeper);
                    }
         }));
