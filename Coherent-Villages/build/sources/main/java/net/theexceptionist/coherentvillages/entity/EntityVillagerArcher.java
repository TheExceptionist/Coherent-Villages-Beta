...
public class EntityVillagerArcher extends AbstractVillagerSoldier implements IRangedAttackMob{
         ...
         this.targetTasks.addTask(0, new EntityAINearestAttackableTarget(this, EntityLiving.class, 1, false, true, new Predicate<EntityLiving>()
                {
                    public boolean apply(@Nullable EntityLiving p_apply_1_)
                    {
                    	...
                    	{
                    		return (p_apply_1_ instanceof EntityAnimal) && !(p_apply_1_ instanceof EntityVillager) && !(p_apply_1_ instanceof EntityHorse);
                    	}
                    }
         }));
